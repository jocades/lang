...
mod tests {
    ...
    #[test]
    fn main() {
        assert_eq!(dbg!(simple(TEST.as_bytes())), Some(12));
        assert_eq!(dbg!(with_vec(TEST.as_bytes())), Some(12));
        assert_eq!(dbg!(with_array(TEST.as_bytes())), Some(12));
        assert_eq!(dbg!(bitwise(TEST.as_bytes())), Some(12));
        // assert_eq!(dbg!(xor(TEST.as_bytes())), Some(12));
        assert_eq!(dbg!(reverse(TEST.as_bytes())), Some(12));
    }
}
